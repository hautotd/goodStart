...
class SubscribeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func subscribeNewUser(sender: AnyObject) {
        ...
        var deviceTokenTmp: String = appDelegate.deviceTokenString.stringByReplacingOccurrencesOfString("<", withString: "").stringByReplacingOccurrencesOfString(">", withString: "") as String
        //deviceTokenTmp = deviceTokenTmp.stringByReplacingOccurrencesOfString(">", withString: "") as String
